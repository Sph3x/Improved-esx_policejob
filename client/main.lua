...
function OpenCloakroomMenu()
	...
	elseif grade == 'paallikko' then
		table.insert(elements, {label = _U('police_wear'), value = 'paallikko_wear'})
	...
	if Config.EnableNonFreemodePeds then
		...
		table.insert(elements, {label = 'Marine', value = 'freemode_ped', maleModel = 's_m_m_scientist_01', femaleModel = 's_m_m_scientist_01'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'paallikko_wear' or
...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
		...
		local elements = {
			...
			{label = _U('deposit_blackmoney'), value = 'deposit_blackmoney'}
		}

		if PlayerData.job.grade_name == 'senior_inspector' or 'superintendent' or 'inspector' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory',
		{
			...
			elseif data.current.value == 'get_stock' then
				OpenGetStocksMenu()
			elseif data.current.value == 'deposit_blackmoney' then
				OpenPutMoney()
			end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions',
	{
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{lavel = "Jalkaraudat",         value = 'legcuff'},
				...
				{label = "Yhdyskuntapalvelu",	value = 'communityservice'}
			}
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'legcuff' then
						TriggerServerEvent('esx_policejob:legcuff', GetPlayerServerId(closestPlayer))
...
function OpenFineMenu(player)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine',
	{
		...
		elements = {
			...
			{label = _U('police_offense'),  value = 4}
		}
	}, function(data, menu)
...
RegisterNetEvent('esx_policejob:legcuff')
AddEventHandler('esx_policejob:legcuff', function()
	IsLegcuffed    = not IsLegcuffed
	local playerPed = PlayerPedId()

	Citizen.CreateThread(function()
		if IsLegdcuffed then
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		local blip3 = AddBlipForCoord(v.Blip3.Pos.x, v.Blip3.Pos.y, v.Blip3.Pos.z)
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'police' then
			...
			for k,v in pairs(Config.PoliceStations) do
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'senior_inspector' or 'superintendent' or 'inspector' then
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'police' then
			...
			for k,v in pairs(Config.PoliceStations) do
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'senior_inspector' or 'superintendent' or 'inspector' or 'lieutenant' then
					for i=1, #v.BossActions, 1 do
...
--[[RegisterNetEvent("trackOFF")
AddEventHandler("trackOFF",function()
tracker = false

end)

RegisterNetEvent("trackON")
AddEventHandler("trackON",function()
tracker = true
